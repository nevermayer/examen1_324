...
<link href="css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="product.css" rel="stylesheet"></head>
	<body>
	...
	<div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
      ...
      <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="bd-theme-text">
		...
		<div class="container">
			<!-- Título de oa página -->
			<div class="row">
				<h2>CRUD a la tabla estudiante</h2>
			</div>
									...
									foreach ($personas as $persona) {
										echo '
											<tr>
												...
												<td><button type="button" class="btn btn-warning text-white" onclick="llenar_datos(`'.$persona['id_persona'].'`, `'.$persona['nombres'].'`, `'.$persona['paterno'].'`, `'.$persona['materno'].'`, `'.$persona['fec_nac'].'`, `'.$persona['sexo'].'`)">Editar</button></td>
												<td><a href="'.base_url('welcome/eliminar/'.$persona['id_persona']).'" type="button" class="btn btn-danger">Eliminar</a></td>
											</tr>
										';
									}
								?>
