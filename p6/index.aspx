...
<head runat="server">
    ...
    <title>INFORMATICA UMSA</title><script src="js/color-modes.js"></script>
...
<body>
    ...
    <main>
        <div class="container">
            <!-- Título de oa página -->
            <div class="row">
                <h2>CRUD a la tabla estudiante con ASP</h2>
            </div>
            <div class="mb-5">
                <form id="form-persona" action="agrega.aspx" method="post" accept-charset="utf-8">
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label for="">Cuenta</label>
                            <input type="text" name="cuenta" class="form-control" required placeholder="Nombre cuenta" id="cuenta">
                        </div>
                        <div class="form-group col-sm-4">
                ...
                <button type="submit" class="btn btn-success btn-block" onclick="limpiar()">Limpiar</button>
            </div>
            <!-- Tabla de datos -->
            <div class="row">
                <div class="card col-12">
                    ...
                    <div class="card-body">
                        <table runat="server" id="miTabla" class="table table-striped" >
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
    ...
    <script>
        ...
        const llenar_datos = (id, nombre, ap, am, fn, genero) => {
            document.getElementById('form-persona').setAttribute('action', url);
        ...
        const limpiar = (id, nombre, ap, am, fn, genero) => {
            document.getElementById('form-persona').setAttribute('action', "agrega.aspx");
